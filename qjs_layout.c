...
static const JSCFunctionListEntry js_layout_proto_funcs[] = {
    ...
    JS_CFUNC_DEF("set_margins", 3, js_layout_set_margins),
    JS_CFUNC_DEF("set_size", 3, js_layout_set_size),
    JS_CFUNC_DEF("set_contain", 3, js_layout_set_contain),
    JS_CFUNC_DEF("set_behave", 3, js_layout_set_behave),
};
